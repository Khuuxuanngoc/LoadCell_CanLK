 ...
 * History:
 *  - 21/5/2025:
 *    - Thay doi ten file thanh HX711_Loadcell_Serial_I2C_LCD_Button_MKLCalculate
 *    - Su dung bo tinh gio của Makerlab để hiển thị loadcell
 *    - Thêm 1 button BUTTON_PIN_SET_DEFAULT_VALUE (12): thay thế chức năng double click của button A1 (đổi qua 11) set SL 5
 *  - 17/4/2025:
 *    - Thêm 1 button A1:
...
void setup() {
  ...
  kxnTask_button1.setup(&kxnTask_LoadCell1, BUTTON_PIN, BUTTON_PIN_SET_DEFAULT_VALUE);
} 
